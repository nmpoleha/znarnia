    ...
    <div className="page">
      ...
      <div className="page__inner">
        ...
        <section className="textblock">
          <h2 className="textblock__title">Летние занятия — это ваш самый мудрый вклад в развитие ребёнка</h2>
          <p className="textblock__p">
            Лето дарит уникальный шанс: без гонки оценок и давления уроков показать ребёнку, что учёба может быть увлекательным квестом, а не скучной обязанностью. Обычные пособия с однотипными примерами убивают этот шанс — они лишь выматывают и отбивают интерес. Лето — это маленькая жизнь, которая может стать мощным трамплином для уверенного старта в сентябре.
          </p>
          <p className="textblock__p">
            Поэтому не откладывайте — оставьте заявку в анкете предзаписи прямо сейчас. Это не обязывает вас ни к чему, кроме одного: получить персональную консультацию, где мы разберём именно вашу ситуацию, боли и цели. Мы подберём тот комфортный летний формат, который даст максимальный результат именно вашему ребёнку. Избавьте себя от головной боли «чем занять и как развивать» — доверьтесь тем, кто сделает это с душой и без скуки.
          </p>
        </section>

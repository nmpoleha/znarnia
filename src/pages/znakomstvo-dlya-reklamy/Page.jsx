    ...
    <div className="zn-page">
      ...
      <main className="zn-main">
        ...
        <section className="zn-start">
          <div className="zn-start__decor" aria-hidden="true">
            <svg className="zn-start__deco zn-start__deco--star" viewBox="0 0 24 24"><path d="M12 2.5l2.9 6 6.6.9-4.8 4.6 1.2 6.5L12 17.4l-5.9 3.1 1.2-6.5-4.8-4.6 6.6-.9z" fill="currentColor" /></svg>
            <svg className="zn-start__deco zn-start__deco--star-sm" viewBox="0 0 24 24"><path d="M12 2.5l2.9 6 6.6.9-4.8 4.6 1.2 6.5L12 17.4l-5.9 3.1 1.2-6.5-4.8-4.6 6.6-.9z" fill="currentColor" /></svg>
            <svg className="zn-start__deco zn-start__deco--tri" viewBox="0 0 60 60"><path d="M12 8l38 22-38 22z" fill="none" stroke="currentColor" strokeWidth="5" strokeLinejoin="round" /></svg>
            <span className="zn-start__deco zn-start__f zn-start__f--1">a² + b² = c²</span>
            <span className="zn-start__deco zn-start__f zn-start__f--2">7 × 8 = 56</span>
            <span className="zn-start__deco zn-start__f zn-start__f--3">S = a · b</span>
            <span className="zn-start__deco zn-start__f zn-start__f--4">x + 5 = 12</span>
            <span className="zn-start__deco zn-start__f zn-start__f--5">½ + ¼ = ¾</span>
            <span className="zn-start__deco zn-start__f zn-start__f--6">P = 2(a + b)</span>
            <span className="zn-start__deco zn-start__f zn-start__f--7">π ≈ 3,14</span>
            <span className="zn-start__deco zn-start__f zn-start__f--8">v = s : t</span>
          </div>

          <div className="zn-start__wrap">
            <div className="zn-start__head">
              <span className="zn-start__eyebrow">Знарния · онлайн-занятия</span>
              ...
              <div className="zn-start__choose">
                <svg className="zn-start__arrow zn-start__arrow--left" viewBox="0 0 64 40" aria-hidden="true"><path d="M58 6C40 4 22 12 12 32M12 32l-1-11M12 32l10-5" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" /></svg>
                <span className="zn-start__pill">
                  Выберите, что сейчас важнее
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M12 4v15M6 13l6 6 6-6" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </span>
                <svg className="zn-start__arrow zn-start__arrow--right" viewBox="0 0 64 40" aria-hidden="true"><path d="M6 6c18-2 36 6 46 26M52 32l1-11M52 32l-10-5" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" /></svg>
              </div>
            </div>
            ...
            <div className="zn-cards">
              ...
              <article className="zn-card zn-card--peach">
                ...
                <div className="zn-card__body">
                  ...
                  <img
                    className="zn-card__img zn-card__img--checklist"
                    src="/znarnia/images/znr-first-checklist.png"
                    alt=""
                    aria-hidden="true"
                    width="520"
                    height="432"
                ...
                <a href="#znakomstvo" className="zn-card__cta zn-card__cta--orange">
                  Записаться на исследование
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 12h15M13 6l6 6-6 6" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </a>
              </article>
              ...
              <article className="zn-card zn-card--violet">
                ...
                <h3 className="zn-card__title">Живой групповой <span className="zn-nowrap">онлайн-урок</span></h3>
                ...
                <div className="zn-card__body">
                  ...
                  <img
                    className="zn-card__img zn-card__img--laptop"
                    src="/znarnia/images/znr-first-laptop.png"
                    alt=""
                    aria-hidden="true"
                    width="600"
                    height="441"
                ...
                <a href="#znakomstvo" className="zn-card__cta zn-card__cta--violet">
                  <span>Попробовать <span className="zn-nowrap">онлайн-урок</span></span>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M4 12h15M13 6l6 6-6 6" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </a>
              </article>
            </div>

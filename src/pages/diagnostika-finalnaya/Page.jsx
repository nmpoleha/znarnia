            ...
            <div className="dg-how__record">
              ...
              <div className="dg-how__steps">
                {[
                  ...
                  recordedFormat ? 'Вам доступна вся функциональность и полная глубина анализа.' : 'При этом сохраняется вся функциональность и глубина анализа.',
                ].map((t, i) => (
              ...
              <div className="dg-how__record-callout">
                ⭐ <strong>{recordedFormat ? 'Вы получите точную и полную картину' : 'Вы получите ту же точную картину'}</strong>{recordedFormat ? '' : ', что и при онлайн-диагностике'}: удобно, информативно и максимально полезно.
              </div>
            </div>

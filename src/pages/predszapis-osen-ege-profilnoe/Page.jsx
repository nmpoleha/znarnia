    ...
    <div className="os-page p2">
      ...
      <header className="os-header">
        <div className="os-header__inner p2-header__inner">
          ...
          <div className="p2-header-badge">🍁 Подготовка к ЕГЭ · профиль</div>
        </div>
      </header>
      ...
      <section className="p2-hero">
        ...
        <div className="p2-hero__inner os-wrap">
          <div className="p2-hero__left">
            <h1 className="p2-hero__title">
              Подготовка к ЕГЭ<br/>
              <span className="p2-hero__title-grade">по профильной математике</span>
            </h1>

            <div className="p2-hero__badge">🍁 Осенний набор открыт</div>

            <p className="p2-hero__desc">{nb('Готовим к ЕГЭ по профильной математике на 80+ баллов благодаря системной проработке каждого задания экзамена.')}</p>
        ...
        <div className="p2-hero__icons os-wrap">
          {[
            'Системная подготовка к ЕГЭ профильного уровня',
            'Проработка каждого номера экзамена',
      ...
      {/* RECORDS + TRANSPARENCY (статистика и просмотр уроков в записи) */}

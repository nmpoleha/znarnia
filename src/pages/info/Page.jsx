      ...
      <div className="page__inner">
        ...
        <div className="info-sections">
          ...
          <FaqCard icon="🔑" title="Куда придёт доступ?">
            <p className="info-card__text">Организационная информация появится на платформе, а также придёт уведомление на почту. Вы точно не пропустите старт занятий 🙂</p>
          </FaqCard>
          ...
          <FaqCard icon="💬" title="Как с нами связаться?">
            <div className="info-contacts">
              ...
              } label="Telegram" value="Написать в Telegram" isLink href="https://t.me/sotnikova_oa_school" />
              <ContactItem icon={
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
              ...
              } label="WhatsApp" value="Написать в WhatsApp" isLink href="https://wa.me/+79955775318" />
              <ContactItem icon="🖥️" label="Платформа" value="Вы можете связаться с нами прямо на платформе — для этого перейдите в личный кабинет по ссылке из письма от нашей школы и воспользуйтесь чатом внутри системы." />

...
export default function Page() {
  ...
  return (
    <div className="os-page p2">
          ...
          <div className="p2-hero__left">
            ...
            <div className="p2-hero__price-block">
              ...
              <div className="p2-hero__price-btns">
                <button className="p2-btn p2-btn--cta" onClick={openPay}>Оставить заявку →</button>
      ...
      {/* ДОП. ПРЕДМЕТЫ ОГЭ */}
      <section className="p2-extra">
        <div className="os-wrap">
          <div className="p2-extra__card">
            <div className="p2-extra__body">
              <span className="p2-extra__eyebrow">📚 Не только математика</span>
              <h2 className="p2-extra__title">
                Подготовка к ОГЭ<br />
                <span className="p2-extra__accent">{nb('по дополнительным предметам')}</span>
              </h2>
              <p className="p2-extra__text">
                <span className="p2-extra__text-l1">Кроме математики готовим к ОГЭ по физике, информатике,</span><br />
                {nb('русскому языку и обществознанию — системно, по актуальному формату экзамена.')}
              </p>
              <div className="p2-extra__cta-row">
                <a className="p2-btn p2-btn--cta p2-extra__btn" href="/znarnia/dop-predmety-oge/">Узнать подробнее →</a>
                <span className="p2-extra__note">
                  <svg className="p2-extra__note-arrow" width="46" height="34" viewBox="0 0 46 34" fill="none" aria-hidden="true">
                    <path d="M44 4C33 2 12 6 4 24" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeDasharray="1 5"/>
                    <path d="M3 16l1 9 9-3" stroke="#7c3aed" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  <span className="p2-extra__note-text">Расширяем возможности<br />увеличиваем результаты!</span>
                </span>
              </div>
            </div>
            <div className="p2-extra__media">
              <img
                src="/znarnia/images/dop-predmety-scene.webp"
                alt="Дополнительные предметы ОГЭ: физика, информатика, русский язык, обществознание"
                className="p2-extra__img"
                width="1120"
                height="719"
                loading="lazy"
                decoding="async"

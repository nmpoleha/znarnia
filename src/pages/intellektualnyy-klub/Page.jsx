      ...
      <div className="sh-wrap sh-reveal__body">
        ...
        <div className="sh-guarantee">
          ...
          <p className="sh-guarantee__text">
            {nbd('Мы уверены в результате, поэтому даём гарантию возврата средств: если в течение 7 дней после начала занятий вам что-то не понравится — вернём деньги в полном объёме.')}
          </p>
        </div>

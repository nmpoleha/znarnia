...
const SCHEDULE = [
  { grade: '11 класс · группа 1', day1: 'Понедельник', day2: 'Четверг',  time: '17:00' },
  { grade: '11 класс · группа 2', day1: 'Вторник',     day2: 'Пятница',  time: '18:00' },
  { grade: '11 класс · группа 3', day1: 'Среда',       day2: 'Суббота',  time: '12:00' },
]
            ...
            <form className="os-modal__form" onSubmit={handleSubmit}>
              ...
              <div className="os-modal__group">
                ...
                <select required value={form.grade} onChange={e => set('grade', e.target.value)}>
                  ...
                  {[11].map(g => <option key={g} value={g}>{g} класс</option>)}
                </select>
              </div>
    ...
    <div className="os-page p2">
      ...
      <header className="os-header">
        <div className="os-header__inner p2-header__inner">
          ...
          <div className="p2-header-badge">🍁 Подготовка к ЕГЭ · 11 класс</div>
        </div>
      </header>
      ...
      <section className="p2-hero">
        ...
        <div className="p2-hero__inner os-wrap">
          <div className="p2-hero__left">
            <h1 className="p2-hero__title">
              Подготовка к ЕГЭ<br/>
              <span className="p2-hero__title-grade">по базовой математике</span>
            </h1>

            <div className="p2-hero__badge">🍁 Осенний набор открыт</div>

            <p className="p2-hero__desc">{nb('Готовим к ЕГЭ по базовой математике на уверенные 4 и 5 благодаря системной проработке каждого задания экзамена.')}</p>
        ...
        <div className="p2-hero__icons os-wrap">
          <div className="p2-hero__icon-item">
            ...
            <span>Разбираем все типы заданий ЕГЭ</span>
          </div>
          <div className="p2-hero__icon-item">
            <div className="p2-hero__icon-box">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <span>Прорабатываем темы, которые чаще всего вызывают трудности</span>
          </div>
          <div className="p2-hero__icon-item">
            <div className="p2-hero__icon-box">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <span>Домашние задания и уроки-тренажёры</span>
          </div>
          <div className="p2-hero__icon-item">
            <div className="p2-hero__icon-box">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden="true">
            ...
            <div className="p2-how__card p2-how__card--purple">
              <div className="p2-how__card-body">
                <div className="p2-how__card-body__header">
                  ...
                  <h3 className="p2-how__card-title">Урок-тренажёр для подготовки к ЕГЭ</h3>
                </div>
      ...
      {/* SCREEN 5 + 6 — WHAT THE PREP INCLUDES / HARD TOPICS */}
      <section className="eb-screens">
        <span className="p2-leaf p2-leaf--1" aria-hidden="true">🍁</span>
        <span className="p2-leaf p2-leaf--2" aria-hidden="true">🍂</span>
        <div className="os-wrap">
          ...
          <div className="eb-scr">
            <div className="eb-scr__text">
              <div className="eb-scr__head">
                <div className="eb-scr__heading">
                  <h2 className="eb-scr__title">Что входит в подготовку</h2>
                </div>
              </div>
              <div className="eb-scr__body">
                <p className="eb-scr__sub">Прорабатываем каждое задание экзамена</p>
                <p className="eb-scr__p">{nb('Мы не просто решаем варианты ЕГЭ. Наша задача — добиться того, чтобы ученик уверенно ориентировался в каждом типе заданий экзамена.')}</p>
                <div className="eb-scr__box">
                  <div className="eb-scr__box-title">Для каждого номера ребёнок получает:</div>
                  <ul className="eb-scr__list">
                    {[
                      'подробное объяснение темы',
                      'все типы возможных задач',
                      'алгоритмы решения',
                      'дополнительные задания для практики',
                      'тренажёр для закрепления навыка',
                    ].map((t, i) => (
                      <li key={i}><EbCheck /><span>{nb(t)}</span></li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="eb-scr">
            <div className="eb-scr__text">
              <div className="eb-scr__head">
                <div className="eb-scr__heading">
                  <h2 className="eb-scr__title">{nb('Особое внимание уделяем самым сложным темам')}</h2>
                </div>
              </div>
              <div className="eb-scr__body">
                <p className="eb-scr__p">{nb('По статистике именно эти задания вызывают наибольшее количество ошибок на экзамене. Поэтому мы уделяем им больше времени и практики.')}</p>
                <div className="eb-scr__box">
                  <div className="eb-scr__box-title">Особенно подробно разбираем:</div>
                  <ul className="eb-scr__list">
                    {['планиметрию', 'стереометрию', 'тригонометрию', 'логарифмы', 'текстовые задачи'].map((t, i) => (
                      <li key={i}><EbCheck /><span>{t}</span></li>
                    ))}
                  </ul>
                </div>

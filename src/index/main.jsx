...
const pages = [
  {
    ...
    description: 'Копия универсальной страницы самостоятельной оплаты для старых учеников: выбор программы по математике (1–11 классы, ОГЭ, ЕГЭ) и оплата занятий онлайн',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'samostoyatelnaya-oplata-universalnaya',
    title: 'Самостоятельная оплата занятий — универсальная',
    client: 'Школа Сотниковой Ольги',
    description: 'Универсальная версия страницы самостоятельной оплаты: в герое — «Выберите программу и оплатите занятия», карточка стоимости «от 580 ₽ / урок» и выбор программы по математике (1–11 классы, ОГЭ, ЕГЭ)',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'znakomstvo-novoe',
    title: 'Новое знакомство',
    client: 'Школа Сотниковой Ольги',
    description: 'Обновлённая версия страницы-знакомства: кнопка «Записаться на занятие» под форматами обучения, блок Интеллектуального клуба выше отзывов и форма заявки в самом конце',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'znakomstvo',
    title: 'Знакомство',
    client: 'Школа Сотниковой Ольги',
    description: 'Страница-знакомство: герой «Современная образовательная платформа» с тезисами, кнопками и приглашением на живое онлайн-занятие',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'zapis-na-urok',
    ...
    client: 'Знарния',
    description: 'Первое занятие с учителем: hero с иллюстрацией, два формата первого занятия (групповой и индивидуальный диагностический урок) и финальная форма заявки',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'konsultatsiya',
    title: 'Консультация',
    client: 'Школа Сотниковой Ольги',
    description: 'Запись на бесплатную консультацию: форма заявки, о платформе, принципы занятий, форматы обучения и социальные доказательства',
    date: 'Сентябрь 2026',
  },
  {
    slug: 'oge-dlya-glavnoy',
    title: 'ОГЭ — дополнительные предметы',
    client: 'Знарния',
    description: 'Подготовка к ОГЭ по дополнительным предметам (русский язык, физика, информатика, обществознание) — блок для главной страницы',
    date: 'Август 2026',
  },
  {
    slug: 'samostoyatelnaya-oplata-osen',
    title: 'Самостоятельная оплата занятий — осень',
    client: 'Школа Сотниковой Ольги',
    description: 'Выбор программы по математике (1–11 классы, ОГЭ, ЕГЭ) и самостоятельная оплата сентября онлайн; в герое — место под фото',
    date: 'Август 2026',
  },
  {
  ...
  {
    slug: 'intellektualnyy-klub-1-8-klass',
    title: 'Интеллектуальный клуб — 1–8 класс',
    client: 'Школа Сотниковой Ольги',
    description: 'Бесплатный клуб для учеников 1–8 классов: еженедельные уроки-тренажёры (математика + мышление), диагностики, проверочные работы, шпаргалки, открытые уроки и подарки',
    date: 'Август 2026',
  },
  {

...
const pages = [
  {
    slug: 'intellektualnyy-klub',
    title: 'Интеллектуальный клуб',
    client: 'Школа Сотниковой Ольги',
    description: 'Бесплатная подписка для учеников 1–9 классов и их родителей — еженедельные материалы: тренажёры, проверочные работы и гайды для родителей',
    date: 'Август 2026',
  },
  {
    slug: 'podgotovka-k-oge',
    title: 'Подготовка к ОГЭ — 9 класс',
    client: 'Школа Сотниковой Ольги',
    description: 'Подготовка к ОГЭ по математике (9 класс) с блоком о подготовке по дополнительным предметам ОГЭ',
    date: 'Август 2026',
  },
  {
    slug: 'partnerskaya-programma-9-klass',
    title: 'Партнёрская программа 9 класс',
    client: 'Школа Знарния',
    description: 'Программа для родителей 9 класса: диагностика, подарки, коллективная скидка для класса и как всё работает (черновик)',
    date: 'Август 2026',
  },
  {
    slug: 'partnerskaya-programma-9-klass-novoe',
    title: 'Партнёрская программа 9 класс — новое',
    client: 'Школа Знарния',
    description: 'Программа для родителей 9 класса: диагностика в формате ОГЭ, подарки, полезные материалы, специальная стоимость и форма заявки',
    date: 'Август 2026',
  },
  {
    slug: 'partnerskaya-programma-9-klass-bez-2-urokov',
    title: 'Партнёрская программа 9 класс — без 2 уроков',
    client: 'Школа Знарния',
    description: 'То же, что «новое», но без блока «Два полноценных урока нашей платформы»',
    date: 'Август 2026',
  },
  {
    slug: 'leto2026',
  ...
  {
    slug: 'avgust',
    title: 'Август — Подготовка к школе (1–11 классы)',
    client: 'Школа Сотниковой Ольги',
    description: 'Две программы («Умный август» и «Экспресс-август»), сравнение, экспресс-диагностика и заявка на консультацию',
    date: 'Июль 2026',
  },
  {
    slug: 'letnie-kursy-2',
